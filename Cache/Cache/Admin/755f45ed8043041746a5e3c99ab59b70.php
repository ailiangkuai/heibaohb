...
<div class="content_2">
	<div class="tabbox" style="display:block;">
      ...
      <tr>
		...
		<td><input type="text" name="catname" id="catname" class="input-text  required" value="<?php echo ($vo['catname']); ?>"  minlength="1"  maxlength="30"  /></td>
		</tr>
		...
		<td><input type="text" id="catdir" name="catdir" class="input-text  required" value="<?php echo ($vo['catdir']); ?>"  minlength="1"  maxlength="30" /></td>
			...
			<tr>
				<td>头部flash</td>
				<td><?php $iconInfo = array ( 'id' => '116', 'moduleid' => '10', 'field' => 'flash', 'name' => '头部flash', 'tips' => '', 'required' => '0', 'minlength' => '0', 'maxlength' => '0', 'pattern' => '0', 'errormsg' => '', 'class' => '', 'type' => 'image', 'setup' => array ( 'size' => '', 'default' => '', 'upload_maxsize' => '', 'upload_allowext' => 'swf', 'watermark' => '0', 'more' => '0', ), 'ispost' => '0', 'unpostgroup' => '', 'listorder' => '0', 'status' => '1', 'issystem' => '0', );?>
					<?php echo Form::file($iconInfo,$vo['flash']);?>
				</td>
			</tr>
