...
<div id="header" class="header">
	<div class="logo"><a href="<?php echo ($site_url); ?>" target="_blank"><img src="./Public/Images/admin_logo.gif" width="180"></a></div>
	<div class="nav f_r"> <a href="javascript:void(0);" onclick="gocacheurl();"><?php echo L('UPDATE_CACHE');?></a> <i>|</i>    &nbsp;&nbsp;</div>
...
<div id="footer" class="footer" >网站内容管理系统 <span id="run"></span></div>
